// Script para habilitar/inhabilitar usuario AdminSENA desde el detalle (adaptado para EditFuncionario.html)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const btnActualizar = document.getElementById('enlaceActualizar') || document.querySelector('a.buttons__crud[href="#"]');
